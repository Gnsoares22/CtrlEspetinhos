<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Garçom.aspx.cs" Inherits="Paginas_Garçom_Garçom" %>
...
<body>
    ...
    <div class="container">
        ...
        <div class="col-xs-12">
            ...
            <asp:Label ID="lblTitulo" runat="server" CssClass="saud" Text="Seja bem vindo Garçom"></asp:Label>
        ...
        <div class="container" style="background-color: black; opacity: .9; border-radius: 10px; padding: 10px 10px 10px 10px">
            ...
            <div class="col-xs-12">
                ...
                <div class="table-responsive">
                    <asp:GridView ID="grdProduto" runat="server" AutoGenerateColumns="False" CssClass="tabela table table-hover" BackColor="White" BorderColor="#999999" BorderStyle="Solid" BorderWidth="1px" CellPadding="3" ForeColor="Black" GridLines="Vertical">
