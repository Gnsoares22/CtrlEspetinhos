<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ListarProdutos.aspx.cs" Inherits="Paginas_Administrador_ListarProdutos" %>
...
<body>
    ...
    <form id="form1" runat="server">
        ...
        <div class="container" style="background-color: black; opacity: .9; border-radius: 10px; padding: 10px 10px 10px 10px">
            ...
            <h2 class="text-center" style="color: whitesmoke; font-family: 'Lobster', cursive;">Lista de Produtos </h2>
            ...
            <div class="text-center col-xs-12">
                ...
                <asp:HyperLink ID="HyperLink1" CssClass="btn btn-primary" NavigateUrl="~/Paginas/Administrador/Adm.aspx" runat="server"> 
            ...
            <div class="col-xs-12">
                ...
                <div class="table-responsive">
                    ...
                    <div class="table-responsive">
                        ...
                        <asp:GridView ID="grdProdutos" runat="server" AutoGenerateColumns="False" CssClass="tabela table table-hover" BackColor="White" BorderColor="#999999" BorderStyle="Solid" BorderWidth="1px" CellPadding="3" ForeColor="Black" GridLines="Vertical" OnRowCommand="grdProdutos_RowCommand">
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="valor_produto" HeaderText="Valor" DataFormatString="{0:C}">
                                    <HeaderStyle CssClass="text-center h4" />
                                    <ItemStyle HorizontalAlign="Center" CssClass="h4" />
                                </asp:BoundField>
                                <asp:BoundField DataField="produto_quantidade" HeaderText="Quantidade">
                                    <HeaderStyle CssClass="text-center h4" />
                                    <ItemStyle HorizontalAlign="Center" CssClass="h4" />
                                </asp:BoundField>
                                ...
                                <asp:TemplateField HeaderText="Ação">
                                    ...
                                    <ItemTemplate>
                                        <asp:LinkButton ID="lbAlterar" CssClass="btn btn-primary" runat="server" CommandName="Darentrada"
                                            CommandArgument='<%# Bind("id_produto")%>'> <span class="glyphicon glyphicon-edit"></span><strong>Dar Entrada </strong></asp:LinkButton>
    ...
    <script>
        ...
        $('.tabela').DataTable({
            ...
            language: {
                ...
                sInfo: "<p> Mostrando de _START_ até _END_ de _TOTAL_ Produtos </p>",
                sInfoEmpty: "<p>Mostrando de 0 até 0 de 0 Produtos</p>",
