<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Alterar.aspx.cs" Inherits="Paginas_Administrador_Alterar" %>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-6 text-left">
                    ...
                    <asp:HyperLink CssClass="btn btn-danger" NavigateUrl="~/Paginas/Administrador/ListarProdutos.aspx" ID="Button1" runat="server">
            ...
            <div class="col-md-12" style="background-color: #000000; opacity: 0.8;">
                ...
                <div class="col-md-12">
                    ...
                    <h2 class="text-center">Dar entrada em Produtos </h2>
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <asp:TextBox CssClass="form-control" ID="txtQuantidade1" TextMode="Number" placeholder="Digite a Quantidade da entrada" runat="server"></asp:TextBox>

                        <asp:RangeValidator ID="RangeValidator1" runat="server" ErrorMessage="RangeValidator" ForeColor="Red" ControlToValidate="txtQuantidade1" MaximumValue="9999" MinimumValue="1">*</asp:RangeValidator>
